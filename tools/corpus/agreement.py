...
def records(coder: str) -> dict[str, dict[str, Any]]:
...
def compare(a: str, b: str) -> int:
    ...
    slide_pairs: dict[str, list[tuple[Any, Any]]] = {f: [] for f in GATED + INFO_SLIDE}
    deck_pairs: dict[str, list[tuple[Any, Any]]] = {f: [] for f in INFO_DECK}
    for deck in shared:
    ...
    for f, pairs in slide_pairs.items():
        ...
        print(
            f"{'GATE' if gate else 'info'} {f:<20} n={len(pairs):<4} kappa={k:.2f}"
