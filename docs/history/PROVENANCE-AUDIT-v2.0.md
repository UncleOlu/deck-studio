...
order. All of these passages were rewritten in 2.0.0.
...
- It says the `pptx-mode.md` footguns were "rewritten in our own words for the public branch". On `main` they have not been, and no public branch exists (branches: `main`, `private/anthropic-pptx-scripts`).
